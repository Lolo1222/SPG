...
SAVE_DIR="${SAVE_DIR_BASE}/spg_generated_so_mix_semi0.9_${TIMESTAMP}"
mkdir -p "$SAVE_DIR"

DATASET="math"
RUN_NAME=${DATASET}_base_spg_generated_so_mix_semi0.9_beta1.5
...
LOGFILE="${LOGDIR}/spg_mix_semi0.9_generated_so_${TIMESTAMP}.out"
