...
SAVE_DIR="${SAVE_DIR_BASE}/spg_generated_so_eubo_mix_${TIMESTAMP}"
mkdir -p "$SAVE_DIR"

DATASET="math"
RUN_NAME=${DATASET}_base_spg_generated_so_eubo_mix_beta1.5
...
LOGFILE="${LOGDIR}/spg_eubo_generated_mix_${TIMESTAMP}.out"
