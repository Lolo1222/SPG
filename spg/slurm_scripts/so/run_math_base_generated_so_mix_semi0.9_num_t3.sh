...
SAVE_DIR="${SAVE_DIR_BASE}/spg_generated_so_mix_semi0.9_num_t3_${TIMESTAMP}"
...
DATASET="math"
RUN_NAME=${DATASET}_base_spg_generated_so_mix_semi0.9_num_t3_beta1.5
...
LOGFILE="${LOGDIR}/spg_mix_semi0.9_num_t3_generated_so_${TIMESTAMP}.out"
