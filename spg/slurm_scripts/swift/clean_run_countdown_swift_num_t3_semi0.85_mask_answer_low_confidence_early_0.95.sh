...
DATASET="countdown"
RUN_NAME=${DATASET}_swift_grpo_generated_num_t3_semi0.85_mask_answer_low_confidence_early0.95
TRAINER="swift"
FORWARD_TYPE="random"
...
ACCEL_CMD=("${ACCEL_BASE[@]}"
  ...
  --semi_offline_data_path dataset/countdown/llada_countdown_generation_converted.jsonl
