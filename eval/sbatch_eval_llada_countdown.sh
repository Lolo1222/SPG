...
for task in "${TASKS[@]}"; do
  for gen_length in "${GEN_LENGTHS[@]}"; do
    ...
    CUDA_VISIBLE_DEVICES=$GPU_LIST torchrun \
      ...
      --output_dir "${SAVE_DIR}/eval_results/countdown_swift_grpo_generated_num_t3_semi0.95_mask_answer_low_confidence_early0.95_20260120_125438" \
      --model_path "/root/jiawei/SPG/save_dir/run_results/countdown_swift_grpo_generated_num_t3_semi0.95_mask_answer_low_confidence_early0.95_20260120_125438/checkpoint-6000"
