...
if __name__ == "__main__":
    ...
    # aggregate_results(directory="save_dir/eval_results/gsm8k_elbo_grpo_num_t3_20260113_172309")
    # aggregate_results(directory="save_dir/eval_results/math_diffu_grpo_20260113_165701")
    # aggregate_results(directory="save_dir/eval_results/math_elbo_grpo_num_t3_20260113_164340")
    # aggregate_results(directory="save_dir/eval_results/math_swift_grpo_generated_num_t3_semi0.9_20260115_010627")
    # aggregate_results(directory="save_dir/eval_results/math_swift_grpo_generated_num_t3_semi0.9_mask_answer_low_confidence_20260115_134454")
    # aggregate_results(directory="save_dir/eval_results/gsm8k_diffu_grpo_20260113_172514")
    # aggregate_results(directory="save_dir/eval_results/gsm8k_elbo_grpo_num_t3_20260113_172309")
    # aggregate_results(directory="save_dir/eval_results/gsm8k_LLaDA-8B-Instruct")
    # aggregate_results(directory="save_dir/eval_results/math_swift_grpo_generated_num_t3_semi0.95_mask_answer_low_confidence_20260116_194747")
    # aggregate_results(directory="save_dir/eval_results/math_swift_grpo_generated_num_t3_early0.9_20260116_005808")
    # aggregate_results(directory="save_dir/eval_results/math_swift_grpo_generated_num_t3_early0.95_20260116_005920")
    # aggregate_results(directory="save_dir/eval_results/gsm8k_swift_grpo_generated_num_t3_semi0.95_mask_answer_low_confidence_early0.95_20260118_013052")
    # aggregate_results(directory="save_dir/eval_results/sudoku_new_swift_grpo_generated_num_t3_semi0.95_mask_answer_low_confidence_early0.95_20260122_124329")
    # aggregate_results(directory="save_dir/eval_results/countdown_elbo_grpo_num_t3_20260116_234720")
    # aggregate_results(directory="save_dir/eval_results/math_swift_grpo_generated_num_t3_semi0.95_random_20260122_160757")
    # aggregate_results(directory="save_dir/eval_results/sudoku_new_swift_grpo_generated_num_t3_semi0.95_mask_answer_low_confidence_early0.95_20260124_130000")
    # aggregate_results(directory="save_dir/new_eval_results/math_swift_grpo_generated_num_t3_semi0.85_mask_answer_low_confidence_early0.95_20260327_045556")
    # aggregate_results(directory="/home/jwliu/dlm/SPG/save_dir/new_eval_results/math_swift_grpo_generated_num_t3_semi0.8_mask_answer_low_confidence_early0.95_20260327_045612")
    # aggregate_results(directory="/home/jwliu/dlm/SPG/save_dir/new_eval_results/math_swift_grpo_generated_num_t3_semi0.85_mask_answer_low_confidence_early0.95_20260327_050526")
    aggregate_results(directory="/home/jwliu/dlm/SPG/save_dir/new_eval_results/token_spg_mix_num_t3_20260402_204134")
    aggregate_results(directory="/home/jwliu/dlm/SPG/save_dir/new_eval_results/token_spg_mix_num_t3_20260402_204258")
