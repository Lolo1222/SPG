...
for task in "${TASKS[@]}"; do
  for gen_length in "${GEN_LENGTHS[@]}"; do
    ...
    CUDA_VISIBLE_DEVICES=$GPU_LIST torchrun \
      ...
      --output_dir "${SAVE_DIR}/eval_results/sudoku_new_swift_grpo_generated_num_t3_semi0.95_mask_answer_low_confidence_early0.95_20260124_130000" \
      --model_path "/root/jiawei/SPG/save_dir/run_results/sudoku_new_swift_grpo_generated_num_t3_semi0.95_mask_answer_low_confidence_early0.95_20260124_130000/checkpoint-2500"
